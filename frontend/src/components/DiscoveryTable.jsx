        ...
        <div className="card__body">
          <div className="discovery-table__empty">
            ...
            <div className="discovery-table__suggestions">
              ...
              <ul>
                <li>
                  Try unchecking <strong>"Reviewed Only"</strong> to include unreviewed (TrEMBL)
                  entries
                </li>
                <li>
                  Change the <strong>Organism</strong> filter to "Any"
                </li>
                <li>
                  Increase the <strong>Length</strong> range to include longer proteins
                </li>
          ...
          <table className="discovery-table" id="discovery-results-table">
            ...
            <tbody>
              {results.map((row) => (
                <tr
                  key={row.accession}
                  className="discovery-table__row"
                  id={`result-${row.accession}`}
                >
                  <td>
